...
// Separate component to avoid IIFE inside AnimatePresence (fixes ref warning)
function PartyDetailOverlay({ pokemon, onClose }: { pokemon: OwnedPokemon; onClose: () => void }) {
      ...
      <div className="min-h-screen pb-24">
        <div className="mx-auto max-w-md px-5 pt-6">
          ...
          <AnimatePresence>
            {partyDetailPokemon && (
              <PartyDetailOverlay
                pokemon={partyDetailPokemon}
                onClose={() => setPartyDetailPokemon(null)}
              />
            )}
          </AnimatePresence>
